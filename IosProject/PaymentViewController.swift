...
let getUserAddress = UserDefaults.standard
    ...
    @IBAction func paymentMethodSegment(_ sender: UISegmentedControl)
    {
        ...
        case 0:
            self.cardNumberLbl.isHidden = true
                   ...
                   self.cvvTxt.isHidden = true
                   self.cardNumberTxt.isHidden = true
                   Cart.cartAccess.paymentMethod = false
        case 1:
             self.cardNumberLbl.isHidden = false
                   self.cvvLbl.isHidden = false
                   self.cvvTxt.isHidden = false
                   self.cardNumberTxt.isHidden = false
                   Cart.cartAccess.paymentMethod = true
        default:
            print("Invalid")
        }
    }
