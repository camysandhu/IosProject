...
class ProductsListViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func mergeItems()
    {
        let product1 = Products(productid: "2222", productName: "Iphone 11 Pro Max", productBrand: "Apple", productDescription: "Four new textured matt glass finishes and stainless-steel design.The iPhone 11 Pro Max features Triple 12 MP Ultra Wide (13mm), Wide (26mm) and Telephoto (52mm) cameras. ", productPrice: 1799.0, productFImage: "appleFront.png", productBImage: "appleBack.png", productQuantity: 1)
        
        let product2 = Products(productid: "3333", productName: "HTC 630", productBrand: "HTC", productDescription: "2 GB RAM | 16 GB ROM | Expandable Upto 256 GB. 8MP Rear Camera | 5MP Front Camera", productPrice: 599.9, productFImage: "htcFront.png", productBImage: "htcBack.png", productQuantity: 1)
        
        let product3 = Products(productid: "4444", productName: "Redmi 8A", productBrand: "MI", productDescription: "The Redmi 8A features a 5000-mAh high-capacity battery, so you can watch more videos, click more pictures, play more games on a single charge. What’s more? It also supports 18 W Fast Charge, so you can get back in action, in no time.", productPrice: 999.9, productFImage: "redmiFront.png", productBImage: "redmiBack.png", productQuantity: 1)
        
        let product4 = Products(productid: "5555", productName: "OPPO A3s", productBrand: "OPPO", productDescription: "The Oppo A3s features a 15.75-cm (6.2) HD+ display and an aspect ratio of 19:9, providing you with a stimulating and immersive visual experience. ", productPrice: 899.8, productFImage: "oppoFront.png", productBImage: "oppoBack.png", productQuantity: 1)
        
        let product5 = Products(productid: "6666", productName: "Samsung S10", productBrand: "Samsung", productDescription: "Get ready to explore the next generation of powerful computing and mobile photography with the Samsung Galaxy S10.", productPrice: 1500.7, productFImage: "samsung10Front.png", productBImage: "Samsung10Back.png", productQuantity: 1
        )
        let product6 = Products(productid: "7777", productName: "VIVO Z1 Pro", productBrand: "VIVO", productDescription: "Powered by the Qualcomm Snapdragon 712 AIE processor and 4 GB of RAM, this phone can handle any task seamlessly. The advanced 10-nm design, a clock speed of up to 2.3 GHz and Adreno 616 G.", productPrice: 1100, productFImage: "oppoFront.png", productBImage: "oppoBack.png", productQuantity: 1)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ItemCell", for: indexPath) as! IItemsListCollectionViewCell
